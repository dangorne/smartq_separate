<?php
  ...
  class Main extends CI_Controller{
    ...
    public function fetchQueuers(){
      ...
      // if($var == ''){
      $search_result = $this->main_model->getQueuers($this->input->post('selected'));
      // }else{
    ...
    public function listselected(){
      ...
      $result = array(
        ...
        'queue_ristriction' => $search_result->queue_ristriction,
    ...
    public function fetchsearch(){
      ...
      foreach ($search_result as $row)
      {
        ...
        echo '<td>'.$row->queue_ristriction.'</td>';
    ...
    // public function joinselected(){
    //
    //   echo json_encode($this->input->post('selected'));
    // }
