<?php
  ...
  class Main extends CI_Controller{
    ...
    public function windowrio(){
      if($this->main_model->getNumberofClients() == 1){
        $this->load->view('window1');
      }else if($this->main_model->getNumberofClients() == 2){
        $this->load->view('window2');
      }
